...
const buttonVariants = cva(
  ...
  text-sm font-bold ring-offset-background transition-colors \
  ...
  uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        primary: "bg-sky-400 text-primary-foreground hover:bg-sky-400/90 \
                  border-sky-500 border-b-4 active:border-b-0",
